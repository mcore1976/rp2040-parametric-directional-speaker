This is the simplest, the cheapest Parametric Directional Speaker you can build. This device uses ultrasound as a carrier for amplitude modulated audible signals and can send it in specified direction on high distance. 
